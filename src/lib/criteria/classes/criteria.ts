...
export class Criteria {
     ...
     */
    static fromBodyParameters(bodyParameters: CriteriaInterface): Criteria {
    ...
    public parseCriteriaToPrisma() {
        return this.concat(this.filters.parseFiltersToPrisma(), this.order);
    }
